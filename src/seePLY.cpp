...
//     //     io::loadPLYFile("/home/ddxy/Downloads/source/pointcloud/kinect/camera1/testcloud/sphere.ply", *sphere);
...
//     if (pcl::io::loadPLYFile<pcl::PointXYZ>("/home/ddxy/Downloads/source/pointcloud/kinect/camera1/sphere.ply", *sphere) == -1)
//     {
//         PCL_ERROR("Couldn't read file sphere.ply \n");
//         return -1;
//     }

//     viewer.addPointCloud(sphere, "sphere", v1);
//     viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 0.5, 0, 0.5, "sphere", v1);
//     viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 5, "sphere", v1);
//     viewer.addCoordinateSystem(50);
...
{
    argv[1] = "/home/ddxy/Downloads/source/pointcloud/kinect/camera1/sphere.ply";
